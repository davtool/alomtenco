 ...
 * @author: [@Arrayfs]
 */
if(!defined('ALOM_VERSION')){define('ALOM_VERSION', '2.8');}
if(!defined('ALOM_VERSION_NUMBER')){define('ALOM_VERSION_NUMBER', 2080);}
if(!class_exists('AlomEncoder'))
    require __DIR__."/alomenobfs.php";
...
function alom_protect($file, $settings = array()){
    ...
    if(!isset($settings['style']['separated_loader']['decoder_file']))
        $settings['outer_decoder'] = __DIR__."/alomdeobfs.php";
...
function alom_autogit(string $path = '.'){
    return copy('https://raw.githubusercontent.com/davtool/alomtenco/master/alomdeobfs.php', "$path/alomdeobfs.php")
        && copy('https://raw.githubusercontent.com/davtool/alomtenco/master/alomenobfs.php', "$path/alomenobfs.php")
        && copy('https://raw.githubusercontent.com/davtool/alomtenco/master/alomtenco.php', "$path/alomtenco.php");
}
